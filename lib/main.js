...
lollib.prototype.getChampions = function(region, fp, cb) {
    ...
    return this.makeRequest(url, cb);
};
...
//api calls for Match stats

lollib.prototype.getMatchById = function(region, matchId, cb) {
    var url = this.generateUrl({
        region: region,
...
lollib.prototype.getMatchList = function(region, summonerId, championIds, rankedQueues, season, beginTime, endTime, beginIndex, endIndex, cb) {
    var query = {
